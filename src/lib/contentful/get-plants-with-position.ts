...
export async function getPlantsWithPosition(
  ...
  const collection = await client.withoutUnresolvableLinks.getEntries<
    PlantEntrySkeleton,
    'fr'
  >(baseQuery);
